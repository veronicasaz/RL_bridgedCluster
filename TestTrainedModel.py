...
def plot_trajs(env, STATES, CONS, Titles, filenames, save_path = None, steps = 100):
    # Setup plot
    label_size = 18
...
def prepare_plot_bridge_vs_no_bridge(env, steps):
        ...
        state_bridge_00, cons_bridge_fast, tcomp_bridge_fast = load_state_files(env, steps, namefile = '_bridge_b0_i0')
        state_bridge_30, cons_bridge_accurate, tcomp_bridge_accurate = load_state_files(env, steps, namefile = '_bridge_b3_i0')
        state_bridge_22, cons_bridge_mid, tcomp_bridge_mid = load_state_files(env, steps, namefile = '_bridge_b2_i2')
        state_bridge_03, cons_bridge_mid, tcomp_bridge_mid = load_state_files(env, steps, namefile = '_bridge_b0_i3')
        state_bridge_33, cons_bridge_mid, tcomp_bridge_mid = load_state_files(env, steps, namefile = '_bridge_b3_i3')
